...
<section> 
    <div class="rumah-banner">
        ...
        <div class="headbar text-center align-items-center">
            <span style="font-size: 7em;">Rumah Universiti</span>
            <span style="font-size: 2em;">by URBAN LIVING</span>
            <div><span class="line-70"></span></div>
        </div>
        <div class="banner-text dancing-script-light">
            <span>Lodging Enhanced</span>
        </div>
        <div class="brands"><span class="line-70"></span></div>
    </div>
</section>
    ...
    <div class="container mt-4 mb-5">
        <div class="row row-cols-3">
            <div class="gallery-item">
                ...
                <span class="d-block mt-2 stigma display-6">The Living Room</p>
            </div>
            <div class="gallery-item">
                <div class="ru-gallery">
                    <img src="assets/Images/rumah/lounge.jpg">
                </div>
                <span class="d-block mt-2 stigma display-6">The Lounge</p>
            </div>
            <div class="gallery-item">
                <div class="ru-gallery">
                    <img src="assets/Images/rumah/room-view2.jpg">
                </div>
                <span class="d-block mt-2 stigma display-6">The Deluxe Quad</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="d-flex align-items-center gap-5">
            ...
            <div class="ru-desc">
                ...
                <div class="d-flex align-items-center gap-4 mt-3">
                    ...
                    <a href="mailto:info@urbanliving.com.my" class="poppins-medium cfs-5">rev@urbanliving.com.my</a>
                </div>
                <div class="d-flex align-items-center gap-4 mt-3">
                    <span class="material-symbols-outlined cfs-1" style="color: var(--secondary-color);">call</span>
                    <span class="poppins-medium cfs-5">+603 7932 6300 / +6016 342 4789</span>
                </div>
            </div>
        </div>
    </div>
