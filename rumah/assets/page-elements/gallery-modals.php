...
<!-- RUMAH UNIVERSITI -->
<!-- Deluxe Queen -->
<div class="modal fade" id="luxqueen" tabindex="-1" aria-labelledby="luxqueen" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <div class="row align-items-center">
            <div class="col-auto">
                <span class="modal-title playfair-bold cfs-3" id="exampleModalLabel">Deluxe Queen</span>
            </div>
            <?php bedLabel('1') ?>
            <?php personLabel('2') ?>
        </div>
      ...
      <div class="modal-body">
        <span class="playfair-semib cfs-5">
            Rumah Universiti Deluxe Queen Rooms are decorated to give our guests an extra comfortable 
            and enjoyable stay. Accommodating up to 2 persons and equipped with high tech comforts 
            such as high speed internet access, USB ports, and a television.
        </span>
        <div class="row row-cols-1 row-cols-lg-2">
            <?php roomPic('rumah','deluxe-queen.jpg') ?>
            <?php roomPic('rumah','room-view.jpg') ?>
            <?php roomPic('rumah','washroom.jpg') ?>
            <?php roomPic('rumah','washroom2.jpg') ?>
        </div>
      </div>
    </div>
  </div>
...
<!-- Deluxe Quad -->
<div class="modal fade" id="luxquad" tabindex="-1" aria-labelledby="luxquad" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <div class="row align-items-center">
            <div class="col-auto">
                <span class="modal-title playfair-bold cfs-3" id="exampleModalLabel">Deluxe Quad</span>
            </div>
            <?php bedLabel('2') ?>
            <?php personLabel('4') ?>
        </div>
      ...
      <div class="modal-body">
        <span class="playfair-semib cfs-5">
            Rumah Universiti Deluxe Quad Rooms features a living room designed to give our guests a space that
            unqiuely belongs to them for all kinds of activities with family and friends. Accommodating up to 
            4 persons and equipped with high tech comforts such as high speed internet access, USB ports, and a television.
        </span>
        <div class="row row-cols-1 row-cols-lg-2">
            <?php roomPic('rumah','deluxe-quad.jpg') ?>
            <?php roomPic('rumah','room-view2.jpg') ?>
            <?php roomPic('rumah','living.jpg') ?>
            <?php roomPic('rumah','washroom2.jpg') ?>
        </div>
      </div>
    </div>
